...
class PeriodsControllerTest < ActionController::TestCase
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post :create, period: { period_end: @period.period_end, period_start: @period.period_start, state_id: @period.state_id, user_id: @period.user_id }
    end
  ...
  test "should update period" do
    patch :update, id: @period, period: { period_end: @period.period_end, period_start: @period.period_start, state_id: @period.state_id, user_id: @period.user_id }
    assert_redirected_to period_path(assigns(:period))
  end
